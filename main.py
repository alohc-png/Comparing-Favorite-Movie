...
actionAndAdventureMovieBooleanList = movieData["genres"].str.contains("Action & Adventure")

actionAndAdventureMovieData = movieData.loc[actionAndAdventureMovieBooleanList]

numOfMovies = actionAndAdventureMovieData.shape[0]
...
#min
min = actionAndAdventureMovieData["audience_rating"].min()
...
#find max
max = actionAndAdventureMovieData["audience_rating"].max()
print("The max audience rating of the data set is: " + str(max))
print(favMovie + " is rated 15 points lower than the highest rated movie.")
print()

#find mean
mean = actionAndAdventureMovieData["audience_rating"].mean()
print("The mean audience rating of the data set is: " + str(mean))
print(favMovie + " is higher than the mean movie rating.")

#find median
median = actionAndAdventureMovieData["audience_rating"].median()
...
#Create histogram
plt.hist(actionAndAdventureMovieData["audience_rating"], range = (0, 100), bins = 20)
...
print("According to the histogram, the audience rating with the most movies is 60-64. There are 275 movies in that range.")
...
#Create scatterplot
plt.scatter(data = actionAndAdventureMovieData, x = "audience_rating", y = "critic_rating")
...
print("According to the scatter plot, there is a positive correlation.")
